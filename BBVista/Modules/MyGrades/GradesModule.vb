Public Class GradesModule
    ...
    Public Function FetchGrades() As List(Of Grade)
        ...
        For Each Match As Text.RegularExpressions.Match In RegEx.Matches(HTML, "<tr>.<td scope=""row"" nowrap=""nowrap""><b>..([^:]+):..?</b></td>..(?:\W+<td> &nbsp; </td><td> &nbsp; </td><td> &nbsp; |.<td>..([0-9.]+).\W+&nbsp;\(out of ([0-9.]+)\)..</td>.<td>..<img[^>]+></td>.\W+<td>(?: &nbsp; |([^<]+)))</td>...</tr>")
